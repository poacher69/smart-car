...
<body>
<p align="center"><input type="button" name="backbtn" id="button1" value="回上一頁" onClick="window.history.back();"></p>
<div class="container">
  <center>
    <h1>  Car Control</h1>  
    
      <div id="link_bar"><button type="submit" class="btn btn-primary" onclick="false"><a href="<?php echo $raspberryPI_Car_IP.$FORWARD_CMD;?>">Forward</a></button><br></div>
