      ...
      <tr valign="top">
        ...
        <div class="regbox">
          <p class="heading"><strong>會員系統</strong></p>
            ...
            <p align="center"><a href="member_adminupdate.php?id=<?php echo $mid;?>">修改資料</a> | <a href="?logout=true">登出系統</a><br><input type="button" name="button" id="button1" value="產品控制" onClick="window.location.href='startbootstrap-grayscale-gh-pages/underdev_Product_Control.php';"></p>
        </div>
