...
if(isset($_GET["logout"]) && ($_GET["logout"]=="true")){
	...
	header("Location: index.php");
  // $_SESSION["smartCarFlag"]=$zero;
  // $_SESSION["adminFlag"]=$zero;
...
$_SESSION['cart_memberName']=$row_RecMember["m_name"];
?>
<html>
<head>
...
<table width="780" border="0" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <td class="tdbline"><img src="images_member/mlogo.png" alt="會員系統" width="350" height="67"></td>
  </tr>
  <tr>
...
<div class="regbox">
          <p class="heading"><strong>會員系統</strong></p>
            ...
            <p align="center"><a href="member_update.php">修改資料</a> | <a href="?logout=true">登出系統</a><br><a href="index_cart.php">進入購物頁面</a><br><input type="button" name="button" id="button1" value="產品控制" onClick="window.location.href='startbootstrap-grayscale-gh-pages/underdev_Product_Control.php';"></p>
</div>
  ...
  <tr>
    <td align="center" background="images_member/album_r2_c1.jpg" class="trademark">© 2018 YVTS IOTB 14Clement.</td>
  </tr>
</table>
</body>
</html>
