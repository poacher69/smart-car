      ...
      <tr valign="top">
        <td width="200" class="tdrline">
            ...
            <div class="categorybox">
             <!--  Clement1213------------------------------ -->
              <!-- <p>Hi,<a href="member_center.php"><?php echo $_SESSION['cart_memberName'];?></a>,Welcome come to Online Shop.</p> -->
              <!-- Clement1213------------------------------ --> 
        ...
        <td><div class="subjectDiv"> <span class="heading"><img src="cart_images/16-cube-green.png" width="16" height="16" align="absmiddle"></span> 產品詳細資料</div>
          <div class="actionDiv"><a href="cart.php">我的購物車</a></div>
          <div class="albumDiv">
            <div class="picDiv">
              <?php if($row_RecProduct["productimages"]==""){?>
              <img src="cart_images/nopic.png" alt="暫無圖片" width="120" height="120" border="0" />
              <?php }else{?>
