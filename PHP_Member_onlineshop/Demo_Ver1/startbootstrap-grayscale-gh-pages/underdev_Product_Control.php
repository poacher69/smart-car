...
$ClementIP = "http://192.168.58.134/";

$buySmartLink = "PHP_practice/Demo_Ver1/product.php?id=19"  
 ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <header class="masthead">
      <div class="container d-flex h-100 align-items-center">
        <div class="mx-auto text-center">
          ...
          <p><a href="#about" class="btn btn-primary js-scroll-trigger">Get Started</a><br><br><?php if($adminFlag==1){print "<a href=\"http://192.168.58.134/PHP_practice/Demo_Ver1/member_admin.php\" class=\"btn btn-primary js-scroll-trigger\">Admin Center</a>";}else{print "<a href=\"http://192.168.58.134/PHP_practice/Demo_Ver1/member_center.php\" class=\"btn btn-primary js-scroll-trigger\">Member Center</a>";}	 ?></p>
        ...
        <div class="row align-items-center no-gutters mb-4 mb-lg-5">
          ...
          <div class="col-xl-4 col-lg-5">
            <div class="featured-text text-center text-lg-left">
              ...
              <p class="text-black-50 mb-0">Layout of car control is coding with PHP,and the vision of SmartCar is made with OpenCV.<br>The OpenCV can help the car turn right and stop when OpenCV detected over 1 object.<img src="img/car.png"></p>
            </div>
          </div>
        </div>
