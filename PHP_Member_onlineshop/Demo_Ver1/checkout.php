  ...
  <tr>
    <td class="tdbline"><table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr valign="top">
          ...
          <td>
          <div class="subjectDiv"><span class="heading"><img src="cart_images/16-cube-green.png" width="16" height="16" align="absmiddle"></span> 購物結帳</div>
            <div class="normalDiv">
              <?php if($cart->itemcount > 0) {?>
              <p class="heading"><img src="cart_images/16-cube-orange.png" width="16" height="16" align="absmiddle"> 購物內容</p>
		  ...
		  ?>
              ...
              <hr width="100%" size="1" />
              <p class="heading"><img src="cart_images/16-cube-orange.png" width="16" height="16" align="absmiddle"> 客戶資訊</p>
